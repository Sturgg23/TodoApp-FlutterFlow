...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for Sign-Up-Email widget.
  ...
  // State field(s) for Sign-Up-Password widget.
  ...
  // State field(s) for Sign-Up-ConfirmPassword widget.
  ...
  // State field(s) for Log-in-Email widget.
  ...
  // State field(s) for Log-in-Password widget.
